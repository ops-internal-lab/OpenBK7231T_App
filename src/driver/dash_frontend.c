...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".trow{display:-webkit-box;-webkit-box-align:center;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;font-family:'Courier New',monospace;font-size:12px;padding:3px 1px;}"
        ".trow .ic{width:15px;height:15px;margin-right:6px;}"
        ".trow .lbl{color:#7c8a9a;min-width:54px;font-weight:bold;}"
        ".trow .val{color:#e7eef6;font-weight:bold;}"
    ...
    poststr(request,
        ...
        ".btn{border:none;color:#fff;border-radius:6px;font-weight:bold;cursor:pointer;overflow:hidden;display:-webkit-box;-webkit-box-orient:vertical;-webkit-box-pack:center;-webkit-box-align:center;display:-webkit-flex;display:flex;-webkit-flex-direction:column;flex-direction:column;-webkit-justify-content:center;justify-content:center;-webkit-align-items:center;align-items:center;-webkit-box-sizing:border-box;box-sizing:border-box;}"
        ".bic{display:block;height:22px;margin-bottom:3px;}"
        ".bic svg{width:22px;height:22px;stroke:currentColor;fill:none;}"
        ".btxt{display:block;font-size:13px;line-height:1;white-space:nowrap;}"
