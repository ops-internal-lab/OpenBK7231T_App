...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        "<div id='d-chg-box'><label id='c-lbl'>ESS Status:</label><b id='c-v'>--</b><span id='c-chg' style='display:block;font-size:14px;color:#4caf50;margin-top:4px;'></span><span id='c-soc' style='display:block;font-size:14px;color:#7c8a9a;margin-top:2px;'>--</span></div>"
        "</div>"
        "<div class='dash-row'>"
    );
    rtos_delay_milliseconds(1);
    ...
    poststr(request,
        ...
        "var soc=b[26];setV('c-soc',(soc===255)?'Battery --':'Battery '+soc+'%');"
    ...
    poststr(request,
        ...
        "function fixBtns(){}"
        "initGrid();loadAll();setInterval(runCycle,10000);fit();btnColor();loadCfg();window.onresize=function(){fit();};setTimeout(function(){fit();},350);"
        "</script></body></html>"
    );
    rtos_delay_milliseconds(1);
