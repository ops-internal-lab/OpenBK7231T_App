...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".btn-auto{-webkit-box-flex:2;-webkit-flex:2;flex:2;margin-bottom:8px;font-size:16px;background:#09F;}"
        ".btn-gear{-webkit-box-flex:1;-webkit-flex:1;flex:1;background:#3a3d42;}"
        ".btn-gear svg{width:20px;height:20px;stroke:#cfd6dd;}"
        ".btn-third{-webkit-box-flex:1;-webkit-flex:1;flex:1;font-size:13px;background:#555;margin-bottom:8px;}"
        ".btn-third.last{margin-bottom:0;}"
        ".tmr{display:none;width:13px;height:13px;margin-right:6px;}"
        ".tmr.show{display:-webkit-inline-box;display:inline-block;}"
        ".cfg-pop{position:absolute;left:14px;right:14px;top:46px;background:#15181d;border:1px solid #3a3d42;border-radius:8px;padding:10px 12px 2px;z-index:30;-webkit-box-sizing:border-box;box-sizing:border-box;}"
    ...
    poststr(request,
        ...
        "</div>"
        "<div class='btn-right'>"
        "<button id='inv-btn' class='btn btn-third' onclick='t_inv()'>INVERTER</button>"
        "<button id='chg-btn' class='btn btn-third' onclick='t_chg()'>CHARGER</button>"
        "<button id='div-btn' class='btn btn-third last' onclick='td()'>"
        "<span class='tmr' id='div-tmr'><svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round' style='width:12px;height:12px;'><circle cx='12' cy='12' r='9'></circle><path d='M12 7v5l3 2'></path></svg></span>"
