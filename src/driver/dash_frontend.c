...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".left-col{-webkit-box-flex:0;-webkit-flex:0 0 251px;flex:0 0 251px;width:251px;background:#222;padding:12px 14px;border-radius:8px;margin-right:14px;-webkit-box-sizing:border-box;box-sizing:border-box;max-height:700px;overflow-y:auto;}"
    ...
    poststr(request,
        ...
        "<div class='sdiv2'></div>"
        "<table class='etbl'>"
        "<tr><th class='nm'>Solar</th><th colspan='2' class='exh'>Generated <span class='unit'>kWh</span></th></tr>"
