...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".sd-val{font-size:14px;font-weight:600;color:#cfd3d8;line-height:1.55;}"
    ...
    poststr(request,
        ...
        "</tr><tr class='sd-tot'>"
        "<td><div class='sd-tnm'>Total Import</div><div class='sd-tval' id='sd-imp'>--</div></td>"
        "<td><div class='sd-tnm'>Total Solar</div><div class='sd-tval' id='sd-sol'>--</div><div class='sd-tnm'>Total ESS</div><div class='sd-tval' id='sd-ess'>--</div></td>"
        "</tr></table>"
    ...
    poststr(request,
        ...
        "function applyMeters(d){if(!d.mt)return;var i,m,el,on,ti=0,tio=0,ts=0,tso=0,te=0,teo=0;"
        "for(i=0;i<6;i++){el=document.getElementById('sd-m'+i);m=d.mt[i];on=m&&m.o;"
        "if(el){if(!on){el.innerHTML='--';el.style.color='#5a6470';}else{el.style.color=(i===5)?((m.w<0)?'#37d67a':'#9aa0a8'):'#cfd3d8';el.innerHTML=(m.v/10).toFixed(1)+'V<br>'+m.w+'W';}}"
        "if(on){if(i<3){ti+=m.w;tio=1;}else if(i<5){ts+=m.w;tso=1;}else{te=m.w;teo=1;}}}"
        "var e1=document.getElementById('sd-imp');if(e1)e1.innerHTML=tio?(ti+'W'):'--';"
        "var e2=document.getElementById('sd-sol');if(e2)e2.innerHTML=tso?(ts+'W'):'--';"
        "var e3=document.getElementById('sd-ess');if(e3){e3.innerHTML=teo?(te+'W'):'--';e3.style.color=teo?((te<0)?'#37d67a':'#9aa0a8'):'#cfd3d8';}}"
