...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".trow{display:-webkit-box;-webkit-box-align:center;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;font-size:12px;padding:3px 1px;}"
        ".trow .ic{width:15px;height:15px;margin-right:6px;}"
        ".trow .lbl{color:#7c8a9a;min-width:54px;font-weight:bold;}"
        ".trow .val{color:#e7eef6;font-weight:bold;font-family:'Courier New',monospace;}"
    ...
    poststr(request,
        ...
        ".bic{display:block;height:22px;margin-bottom:3px;}"
        ".bic svg{width:22px;height:22px;stroke:currentColor;fill:none;}"
        ...
        ".cfg-pop{position:absolute;left:14px;right:14px;top:26px;background:#15181d;border:1px solid #3a3d42;border-radius:8px;padding:10px 12px 2px;z-index:30;-webkit-box-sizing:border-box;box-sizing:border-box;}"
