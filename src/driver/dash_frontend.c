...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".sns-g{display:table;width:100%;border-collapse:collapse;margin-top:8px;}"
    ...
    poststr(request,
        ...
        "<div class='mbody'><table class='mtbl'>"
        "<tr><th class='nm'>Period</th><th colspan='2' style='text-align:right'>Generated <span style='font-weight:400;color:#444'>kWh</span></th></tr>"
        ...
        "<div class='sns-g'>"
        "<div class='sns-row'>"
        "<div class='sns-c1'><div class='sd-nm'><svg width='10' height='10' viewBox='0 0 24 24' fill='#f2b84b'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>L1</div><div class='sd-val' id='sd-m0'>--</div></div>"
        "<div class='sns-c1'><div class='sd-nm'><svg width='10' height='10' viewBox='0 0 24 24' fill='#f2b84b'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>L2</div><div class='sd-val' id='sd-m1'>--</div></div>"
        "<div class='sns-c1'><div class='sd-nm'><svg width='10' height='10' viewBox='0 0 24 24' fill='#f2b84b'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>L3</div><div class='sd-val' id='sd-m2'>--</div></div>"
        "</div>"
        "<div class='sns-row'>"
        "<div class='sns-c2'><div class='sd-nm'><svg width='11' height='11' viewBox='0 0 24 24' fill='none' stroke='#f2b84b' stroke-width='2.5' stroke-linecap='round'><circle cx='12' cy='12' r='4'/><line x1='12' y1='2' x2='12' y2='6'/><line x1='12' y1='18' x2='12' y2='22'/><line x1='4.93' y1='4.93' x2='7.76' y2='7.76'/><line x1='16.24' y1='16.24' x2='19.07' y2='19.07'/><line x1='2' y1='12' x2='6' y2='12'/><line x1='18' y1='12' x2='22' y2='12'/><line x1='4.93' y1='19.07' x2='7.76' y2='16.24'/><line x1='16.24' y1='7.76' x2='19.07' y2='4.93'/></svg>S1</div><div class='sd-val' id='sd-m3'>--</div></div>"
        "<div class='sns-c2'><div class='sd-nm'><svg width='11' height='11' viewBox='0 0 24 24' fill='none' stroke='#f2b84b' stroke-width='2.5' stroke-linecap='round'><circle cx='12' cy='12' r='4'/><line x1='12' y1='2' x2='12' y2='6'/><line x1='12' y1='18' x2='12' y2='22'/><line x1='4.93' y1='4.93' x2='7.76' y2='7.76'/><line x1='16.24' y1='16.24' x2='19.07' y2='19.07'/><line x1='2' y1='12' x2='6' y2='12'/><line x1='18' y1='12' x2='22' y2='12'/><line x1='4.93' y1='19.07' x2='7.76' y2='16.24'/><line x1='16.24' y1='7.76' x2='19.07' y2='4.93'/></svg>S2</div><div class='sd-val' id='sd-m4'>--</div></div>"
        "</div>"
        "<div class='sns-row'>"
        "<div class='sns-c3'><div class='sd-nm'><svg width='13' height='10' viewBox='0 0 24 24' fill='none' stroke='#37d67a' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='2' y='7.5' width='16' height='9' rx='2'/><path d='M21 11v2'/></svg>ESS</div><div class='sd-val' id='sd-m5'>--</div></div>"
        "</div>"
        "</div>"
        "<div class='sns-now' style='margin-top:4px;'>"
        "<div class='sns-now-c'><div class='sns-nl'>Solar now</div><div class='sns-nv' id='sd-sol-now'>--</div></div>"
        "<div class='sns-now-c'><div class='sns-nl'>ESS now</div><div class='sns-nv' id='sd-ess-now'>--</div></div>"
        "</div>"
        "<div class='sdiv'></div>"
        "<div class='shdr'>"
        ...
        "</div>"
        "<table class='etbl'>"
        "<tr><th class='nm'></th><th>Import <span class='unit'>kWh</span></th><th class='exh'>Export <span class='unit'>kWh</span></th></tr>"
        ...
        "</table>"
        "<div class='sdiv'></div>"
        "<div class='shdr'><span class='slbl'>Battery Details</span></div>"
        "<table class='etbl2'>"
        "<tr><th class='nm'></th><th>Import <span style='font-weight:400;color:#444'>kWh</span></th><th style='text-align:right;padding-left:10px;'>Export <span style='font-weight:400;color:#444'>kWh</span></th></tr>"
        "<tr><td class='nm'>Today</td><td class='num mi' id='sd-ess-tod-i'>--</td><td class='num me' style='padding-left:10px;' id='sd-ess-tod-e'>--</td></tr>"
        "<tr class='tot'><td class='nm'>Total</td><td class='num mi' id='h-eitot2'>--</td><td class='num me' style='padding-left:10px;' id='h-eetot2'>--</td></tr>"
        "</table>"
        "<div class='sdiv'></div>"
        "<div class='shdr'><span class='slbl'>Solar Details</span></div>"
        "<table class='etbl2'>"
        "<tr><th class='nm'></th><th colspan='2' style='text-align:right'>Generated <span style='font-weight:400;color:#444'>kWh</span></th></tr>"
    ...
    poststr(request,
        ...
        "function applyMeters(d){if(!d.mt)return;var i,m,el,on,ts=0,tso=0,te=0,teo=0;"
        ...
        "if(d.gen){"
        "setV('sd-sol-tod',_wh2(d.gen.d)+' kWh');"
        "setV('h-gstot',_wh1(d.gen.t)+' kWh');setV('h-gstot2',_wh1(d.gen.t)+' kWh');"
        "if(d.gen.h&&d.gen.h.length===3){"
        "setV('h-gs1',_wh2(d.gen.h[0])+' kWh');"
        "setV('h-gs2',_wh2(d.gen.h[1])+' kWh');"
        "setV('h-gs3',_wh2(d.gen.h[2])+' kWh');}}"
        "if(d.imp&&d.exp){"
        "setV('sd-ess-tod-i',_wh2(d.imp.d)+' kWh');setV('sd-ess-tod-e',_wh2(d.exp.d)+' kWh');"
        "setV('h-eitot',_wh1(d.imp.t)+' kWh');setV('h-eitot2',_wh1(d.imp.t)+' kWh');"
        "setV('h-eetot',_wh1(d.exp.t)+' kWh');setV('h-eetot2',_wh1(d.exp.t)+' kWh');"
