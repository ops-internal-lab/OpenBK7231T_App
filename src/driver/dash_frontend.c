...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        ".cfg-pop{position:absolute;left:14px;right:14px;top:46px;background:#15181d;border:1px solid #3a3d42;border-radius:8px;padding:12px 12px 2px;z-index:30;-webkit-box-sizing:border-box;box-sizing:border-box;}"
