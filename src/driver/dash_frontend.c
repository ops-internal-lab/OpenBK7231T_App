...
int http_fn_custom_dash(http_request_t *request) {
    ...
    poststr(request,
        ...
        "<table class='snsd'>"
        "<tr>"
        "<td><div class='sd-nm'><svg width='11' height='11' viewBox='0 0 24 24' fill='#f2b84b'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>L1</div><div class='sd-val' id='sd-m0'>--</div></td>"
        "<td><div class='sd-nm'><svg width='12' height='12' viewBox='0 0 24 24' fill='none' stroke='#f2b84b' stroke-width='2.5' stroke-linecap='round'><circle cx='12' cy='12' r='4'/><line x1='12' y1='2' x2='12' y2='6'/><line x1='12' y1='18' x2='12' y2='22'/><line x1='4.93' y1='4.93' x2='7.76' y2='7.76'/><line x1='16.24' y1='16.24' x2='19.07' y2='19.07'/><line x1='2' y1='12' x2='6' y2='12'/><line x1='18' y1='12' x2='22' y2='12'/><line x1='4.93' y1='19.07' x2='7.76' y2='16.24'/><line x1='16.24' y1='7.76' x2='19.07' y2='4.93'/></svg>S1</div><div class='sd-val' id='sd-m3'>--</div></td>"
        "</tr><tr>"
        "<td><div class='sd-nm'><svg width='11' height='11' viewBox='0 0 24 24' fill='#f2b84b'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>L2</div><div class='sd-val' id='sd-m1'>--</div></td>"
        "<td><div class='sd-nm'><svg width='12' height='12' viewBox='0 0 24 24' fill='none' stroke='#f2b84b' stroke-width='2.5' stroke-linecap='round'><circle cx='12' cy='12' r='4'/><line x1='12' y1='2' x2='12' y2='6'/><line x1='12' y1='18' x2='12' y2='22'/><line x1='4.93' y1='4.93' x2='7.76' y2='7.76'/><line x1='16.24' y1='16.24' x2='19.07' y2='19.07'/><line x1='2' y1='12' x2='6' y2='12'/><line x1='18' y1='12' x2='22' y2='12'/><line x1='4.93' y1='19.07' x2='7.76' y2='16.24'/><line x1='16.24' y1='7.76' x2='19.07' y2='4.93'/></svg>S2</div><div class='sd-val' id='sd-m4'>--</div></td>"
        "</tr><tr>"
        "<td><div class='sd-nm'><svg width='11' height='11' viewBox='0 0 24 24' fill='#f2b84b'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>L3</div><div class='sd-val' id='sd-m2'>--</div></td>"
        "<td><div class='sd-nm'><svg width='14' height='11' viewBox='0 0 24 24' fill='none' stroke='#37d67a' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='2' y='7.5' width='16' height='9' rx='2'/><path d='M21 11v2'/></svg>ESS</div><div class='sd-val' id='sd-m5'>--</div></td>"
        "</tr></table>"
        "<table class='etbl' style='margin-top:14px;'>"
        "<tr><th class='nm'></th><th>Solar</th><th class='exh'>ESS <span class='unit'>imp / exp</span></th></tr>"
        "<tr><td class='nm'>Now</td><td class='num' id='sd-sol-now'>--</td><td class='num' id='sd-ess-now'>--</td></tr>"
        "<tr><td class='nm'>Today</td><td class='num' id='sd-sol-tod'>--</td><td class='num' id='sd-ess-tod'>--</td></tr>"
        "<tr class='tot'><td class='nm'>Total</td><td class='num' id='sd-sol-tot'>--</td><td class='num' id='sd-ess-tot'>--</td></tr>"
        "</table>"
        "<table class='etbl' style='margin-top:14px;'>"
    ...
    poststr(request,
        ...
        // Solar / ESS "Now" = live instantaneous power (needs a fresh/stale meter).
        "setV('sd-sol-now',tso?(ts+'W'):'--');"
        "setV('sd-ess-now',teo?(te+'W'):'--');"
        // Today / Total = stored energy counters (Wh) — shown regardless of meter state.
        "if(d.gen){setV('sd-sol-tod',_wh2(d.gen.d)+' kWh');setV('sd-sol-tot',_wh1(d.gen.t)+' kWh');}"
        "if(d.imp&&d.exp){setV('sd-ess-tod',_wh2(d.imp.d)+' / '+_wh2(d.exp.d));"
        "setV('sd-ess-tot',_wh1(d.imp.t)+' / '+_wh1(d.exp.t));}}"
